...
### – 5 Практическая работа «Интеграция системы достижений в проект»
Ход работы:
1) Напишем скрипт, который отвечает за обработку данных достижений пользователя.

2) Добавим раздел в меню, который будет нас перенаправлять на список достижений в игре. Выполним настройки перехода между окнами. 

3) Визуально настроим окно достижений.
